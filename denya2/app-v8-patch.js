(function(){
  ...
  newQuote=function(editId=null){
    ...
    const w=modal(existing?'Editar cotización':'Nueva cotización',`
      ...
      <div class="quote-section"><h3>📝 Detalles del pedido</h3><div class="form2">${selectField('Hora de entrega','qtime',[{value:'',label:'Selecciona una hora'},{value:'00:00',label:'00:00'},{value:'00:30',label:'00:30'},{value:'01:00',label:'01:00'},{value:'01:30',label:'01:30'},{value:'02:00',label:'02:00'},{value:'02:30',label:'02:30'},{value:'03:00',label:'03:00'},{value:'03:30',label:'03:30'},{value:'04:00',label:'04:00'},{value:'04:30',label:'04:30'},{value:'05:00',label:'05:00'},{value:'05:30',label:'05:30'},{value:'06:00',label:'06:00'},{value:'06:30',label:'06:30'},{value:'07:00',label:'07:00'},{value:'07:30',label:'07:30'},{value:'08:00',label:'08:00'},{value:'08:30',label:'08:30'},{value:'09:00',label:'09:00'},{value:'09:30',label:'09:30'},{value:'10:00',label:'10:00'},{value:'10:30',label:'10:30'},{value:'11:00',label:'11:00'},{value:'11:30',label:'11:30'},{value:'12:00',label:'12:00'},{value:'12:30',label:'12:30'},{value:'13:00',label:'13:00'},{value:'13:30',label:'13:30'},{value:'14:00',label:'14:00'},{value:'14:30',label:'14:30'},{value:'15:00',label:'15:00'},{value:'15:30',label:'15:30'},{value:'16:00',label:'16:00'},{value:'16:30',label:'16:30'},{value:'17:00',label:'17:00'},{value:'17:30',label:'17:30'},{value:'18:00',label:'18:00'},{value:'18:30',label:'18:30'},{value:'19:00',label:'19:00'},{value:'19:30',label:'19:30'},{value:'20:00',label:'20:00'},{value:'20:30',label:'20:30'},{value:'21:00',label:'21:00'},{value:'21:30',label:'21:30'},{value:'22:00',label:'22:00'},{value:'22:30',label:'22:30'},{value:'23:00',label:'23:00'},{value:'23:30',label:'23:30'}],existing?.time||'')}${field('Anticipo %','qdeposit',existing?.deposit||50,'number')}${area('Comentarios del pedido','qnotes','')}${field('Imagen de referencia','qimage','','file')}</div></div>
    ...
    `,wrap=>{
      ...
      const data={id:existing?.id||'q'+Date.now(),folio:wrap.querySelector('#qfolio').value,client,event:wrap.querySelector('#qevent').value,status:wrap.querySelector('#qstatus').value,total:result.total,balance:result.balance,productId:wrap.querySelector('#qproduct').value,measureId:wrap.querySelector('#qmeasure').value,quantity:Math.max(1,Number(wrap.querySelector('#qquantity')?.value)||1),deposit:Number(wrap.querySelector('#qdeposit').value)||50,time:wrap.querySelector('#qtime').value,versions:(existing?.versions||0)+1,selections:clone(selections),packages:clone(packages),customExtras:clone(customExtras)};
