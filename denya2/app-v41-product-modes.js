(function(){
  ...
  window.newQuote=function(editId=null){
    ...
    `,wrap=>{
      ...
      const p=getProduct(wrap.querySelector('#qproduct').value),mode=ptype(p);
    ...
    function renderConfigurator(){
      const p=getProduct(psel.value),mode=ptype(p),ms=state.measures.filter(m=>m.productId===p.id),box=w.querySelector('#qConfigurator'),badge=w.querySelector('#qModeBadge');
